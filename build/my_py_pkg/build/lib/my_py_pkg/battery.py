...
class BatteryNode(Node):
    ...
    def call_set_led_server(self, led_number, states):
        ...
        future.add_done_callback(
            partial(self.callback_call_set_led, led_number=led_number, states=states))

    def callback_call_set_led(self, future, led_number, states):
        try:
